// --------------------------------------------------------------------------------------------------------------------
// <copyright file="KafkaProtocolConsumerLeaveGroupRequest.cs" company="">
...
{
    /// <summary>
    /// The request to leave a consumer group.
    /// </summary>
    public class KafkaProtocolConsumerLeaveGroupRequest : KafkaProtocolRequest
    {
        /// <summary>
        ...
        public override KafkaProtocolApiKey ApiKey
        {
            get
            {
                return KafkaProtocolApiKey.LeaveGroupRequest;
            }
        }
    }
}